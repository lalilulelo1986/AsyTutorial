 ...
 */
public class S_Tutorial2 extends GCFServerBinder implements C_Tutorial2 {
		 ...
		 */
		public static final String DB_URL_PROPERTY = S_Tutorial2.class.getName() + "#TUTORIAL_PERSON_DataBaseURL";
	
		/**
		 * Name of the database identifier for the user name. The actual name will
		 * be loaded from the resource file.
		 */
		public static final String DB_USR_PROPERTY = S_Tutorial2.class.getName() + "#TUTORIAL_PERSON_DataBaseUser";
	
		/**
		 * Name of the database identifier for the user password. The actual name
		 * will be loaded from the resource file.
		 */
		public static final String DB_PWD_PROPERTY = S_Tutorial2.class.getName() + "#TUTORIAL_PERSON_DataBasePassword";
		...
		public void defineBinder() {
			TC_Tutorial2 tc = new TC_Tutorial2(this, getConnectionManager(0));
			addServerRule(tc);
		...
		public static String getPERSON_TAB() {
			return Server.getString(S_Tutorial2.class, PERSON_TAB);
		}

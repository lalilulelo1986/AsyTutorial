...
public interface C_Tutorial6 {
	...
	// Segment Conjoint
	public static final String CJT = "CJT";
	// Segment tmp
	...
	public static final String OP_FIND_MALE = "Find Male";
	...
	public static final int OI_FIND_MALE = Operation.INTERNAL_OPERATIONS_MAX + 4;
	public static final int OI_FIND_REGISTERED = Operation.INTERNAL_OPERATIONS_MAX + 3;
	...
	// Visual middle events
	public static final int RET_CJT_BY_LNA = EventConstants.INTERNAL_EVENTS_MAX + 1014;
	public static final int RET_CJT_BY_ID = EventConstants.INTERNAL_EVENTS_MAX + 1015;

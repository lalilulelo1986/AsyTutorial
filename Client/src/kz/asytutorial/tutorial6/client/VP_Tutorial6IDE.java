...
public class VP_Tutorial6IDE extends ElfVisualPage implements C_Tutorial6 {
	...
	transient private ElfField fld_Conjoint_FirstName =elfFieldPool.getKTextField();
	transient private ElfField fld_Conjoint_LastName = elfFieldPool.getKTextField();


	public VP_Tutorial6IDE() {
	...
	public void initVisualControls() {
		...
		add(100,250,100,20, fld_Conjoint_LastName,lng("Conjoint last name"));
		add(220,250,100,20, fld_Conjoint_FirstName,lng("Conjoint first name"));
	...
	public void initFacets() {
		...
		addFacetText(fld_Conjoint_FirstName,ds(CJT).ds(IDE).de(FNA),"X35");
		addFacetText(fld_Conjoint_LastName,ds(CJT).ds(IDE).de(LNA),"X35");
		addFacetImage(img_Picture, ds(IDE).de(PIC));
	}

	public void initRules() {
		fld_Conjoint_FirstName.setEnabled(false);
	}
